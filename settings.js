...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=fnJkRJzb#neLk2fweb-sVZ_4ehBK78NkPCAN3HL2uhlNlX3VOJtA' : process.env.SESSION_ID,
...
AUTO_STICKER: process.env.AUTO_STICKER === undefined ? "ture" : process.env.AUTO_STICKER,
